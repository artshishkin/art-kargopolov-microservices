...
2.  Provision EC2 instance for Node01
    -  for node1 choose t2.medium EC2 instance with [UserDataNode1.sh](deploy/ec2-swarm/UserDataNode1.sh)
    -  attach security groups
        -  `docker-swarm-cluster`
        -  `microservices-sg` (allow SSH 22)
3.  Provision EC2 instances for Node02...Node05
    -  node1 -> Actions -> Launch more like this ->
    -  modify UserData with [UserDataNode2345.sh](deploy/ec2-swarm/UserDataNode2345.sh)
    -  ssh to node01
